...
// Answer:
//  Set the starting counter to 0: Create a variable counter and initialize it to 0.
let counter = 0;
// Create a variable, step, to increase your counter by: Define a variable step to hold the value by which the counter will be incremented.
let step = 5;
// Add a do...while loop: In the loop, print the counter to the console and increment it by the step amount each iteration.
// Continue to loop until the counter is equal to or more than 100: The loop should run as long as the counter is less than 100.
do {
    console.log(counter);
    counter += step;
} while (counter < 100);
